...
| Option | Type | Required | Default Value | Description |
|---|---|---|---|---|
| path | string | no | *none* | Defines the path of the web application, containing the application files. If this will not be set, the [Placeholder App](../getting-started/driver-configuration.md) will be used. |
