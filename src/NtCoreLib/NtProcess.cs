...
public class NtProcess : NtObjectWithDuplicateAndInfo<NtProcess, ProcessAccessRights, ProcessInformationClass, ProcessInformationClass>
{
    ...
    private static NtProcessCreateResult Create(NtProcessCreateConfig config, string image_path, bool fork, bool throw_on_error, StringBuilder logger)
    {
        ...
        {
            logger.AppendLine("Reached success");
        ...
        {
            logger.AppendLine("Reached non success");
    ...
    public static NtProcessCreateResult Create(NtProcessCreateConfig config, bool throw_on_error, StringBuilder logger)
    {
        string image_path = config.ImagePath ?? config.ConfigImagePath;
        if (image_path == null)
            throw new ArgumentNullException("image_path");

        return Create(config, image_path, false, throw_on_error, logger);
    }
    ...
    {
        return Create(config, true, null);
    }
    ...
    {
        return Create(config, string.Empty, true, throw_on_error, null);
    }
